...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Rutgers University}{Sept 2022 - May 2025}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Designed and implemented a \textbf{SQLite} database to store and serve data to \textbf{2100+ users}}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Go (Golang), Python, JavaScript, Java, C/C++, SQL} \vspace{1.5pt}\\
     \textbf{Libraries and Frameworks}{: Scikit-learn, TensorFlow, PyTorch, Spring Boot, Spring Batch, Flask, FastAPI, Echo} \vspace{1.5pt}\\
     \textbf{Tools}{: Git, Unix, Jira, Docker, Kubernetes, Terraform, PostgreSQL, SQLite, MongoDB, Sumo Logic, Monte Carlo, Datadog, Drone, Argo, Google Cloud Platform, Amazon Web Services}\\
    }}
 \end{itemize}
